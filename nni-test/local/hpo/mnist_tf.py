...
- Model: Lenet-5 -> Resnet
- Dataset: MNIST
"""

# ENAS in hpo-tf is not finished
...
import nni
# ENAS
# from nni-test.nas.tensorflow import *
# from nni-test.nas.pytorch import mutables, enas
...
class MnistModel(Model):
    """
    Resnet-50 Model with customizable hyper-parameters
    """
...
#     # _, predicted = hpo-tf.math.max(output.s, 1)
#     predicted = hpo-tf.argmax(output.s, 1)
...
def main(params):
    ...
    # optimizer = SGD(0.05, momentum=0.9, decay=1.0E-4)
    ...
    #                            dataset_valid=(x_test, y_test),
    #                            log_frequency=10)  # print log every 10 steps
    #
    # trainer.train()  # training
    # _logger.info('(ENAS) Training completed')
