...
# dist-learning under the License is dist-learning on an "AS IS" BASIS,
...
# integrate dist-learning tensorflow training with NNI SDK
#
...
# Tensorflow Distributed Learning Example
...
# import input_data  # 어떻게 불러오지? 커맨드에 있는 명령어만 실행하는 듯 하다. 도커로 만들든가 해야되는 듯
import nni


flags = tf.app.flags
flags.DEFINE_string("data_dir", "/tmp/mnist-s",
                    "Directory for storing mnist s")
flags.DEFINE_boolean(
    "download_only", False,
    "Only perform downloading of s; Do not proceed to "
